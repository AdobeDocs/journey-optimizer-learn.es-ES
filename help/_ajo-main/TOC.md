...
+ Introducción a Journey Optimizer {#introduction-to-journey-optimizer}
  ...
  + {hide-from-toc}[Arquitectura](/help/introduction/architecture.md)
...
+ Recorridos {#journeys}
  ...
  + [Introducción al nuevo lienzo de recorrido](/help/journeys/introduction-to-the-new-journey-canvas.md)
...
+ [Lealtad](https://experienceleague.adobe.com/es/docs/journey-optimizer-learn/loyalty/introduction-to-loyalty/discover-journey-optimizer-loyalty)
...
+ Perfiles, públicos y suscripciones {#profiles-audiences-subscriptions}
  ...
  + {hide-from-toc}[Perfil unificado y segmentación: información general](/help/profiles-audiences-subscriptions/unified-profile-and-segmentation-overview.md)
  ...
  + [Suscripciones y páginas de destino](/help/profiles-audiences-subscriptions/subscriptions-and-landing-pages.md)
+ Canales {#channels}
  ...
  + Canal push{#push-channel}
    ...
    + [Tutorial detallado sobre las notificaciones push web](https://experienceleague.adobe.com/es/docs/journey-optimizer-learn/ajo-web-push/introduction)
  ...
  + WhatsApp {#whatsapp}
    + {hide-from-toc}[Introducción a WhatsApp (de extremo a extremo)](/help/channels/get-started-with-whatsapp-in-ajo.md)
...
+ Administración de contenido{#content-management}
  ...
  + Trabajo con fragmentos {#fragments}
    ...
    + [Uso de fragmentos de contenido de AEM (Managed Services)](/help/content-management/aem-content-fragments-managed-services.md)
...
+ Funcionalidades de decisión{#decision-capabilities}
  + Toma de decisiones {#decisioning}
    ...
    + Uso de decisiones para personalizar mensajes {#use-decisioning}
      ...
      + {hide-from-toc}[Usar la toma de decisiones en el editor visual web](/help/decisioning/use-decisioning-within-the-web-visual-editor.md)
