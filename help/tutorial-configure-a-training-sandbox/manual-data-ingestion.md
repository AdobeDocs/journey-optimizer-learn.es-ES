...
description: Cree conjuntos de datos e introduzca manualmente datos de ejemplo.
...
El siguiente tutorial de vídeo explica cómo crear conjuntos de datos e introducir datos manualmente:
...
Si aún no lo ha hecho, descargue los siguientes archivos JSON con los datos de ejemplo e introduzca los datos en los conjuntos de datos respectivos:
...
Ha creado correctamente todos los conjuntos de datos necesarios y ha introducido los datos de ejemplo. El paso final es [configurar eventos](/help/tutorial-configure-a-training-sandbox/configure-events.md).
