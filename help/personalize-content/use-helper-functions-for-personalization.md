...
Consulte la guía del producto para obtener más información acerca de las [funciones de ayuda](https://experienceleague.adobe.com/docs/journey-optimizer/using/personalized-dynamic-content/personalization/build-expressions/functions/functions.html?lang=en).
